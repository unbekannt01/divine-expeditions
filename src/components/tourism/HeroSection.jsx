    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 pb-12 sm:pt-24 sm:pb-16">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 text-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 bg-card/80 backdrop-blur-sm px-4 py-2 rounded-full border border-border mb-6 sm:mb-8 text-xs sm:text-sm"
        >
          <Sparkles className="w-4 h-4 text-accent" />
          <span className="font-medium text-muted-foreground">Premium Pilgrimage Tours</span>
        </motion.div>
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="inline-flex items-center gap-2 sm:gap-3 px-6 sm:px-8 py-3 sm:py-4 rounded-full bg-gradient-to-r from-accent to-primary text-accent-foreground font-bold text-sm sm:text-lg shadow-2xl shadow-accent/40 hover:shadow-accent/60 transition-shadow"
        >
